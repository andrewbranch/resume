...
\raggedright
I'm a software engineer with a passion for making other people's lives easier. I love designing APIs that are intuitive but powerful. Writing good documentation is one of my highest priorities. Technologies that let me write more expressive code excite me. I love collaborating and exchanging knowledge with others, and I'm constantly looking for a challenge.
...
\section{Work Experience}
	...
	\begin{itemize}%
		...
		\item Migrated multiple applications to Kubernetes
	...
	\begin{minipage}[t]{0.5\textwidth}
		...
		\cvitem{Techniques~\& concepts}{\small
			\begin{itemize}
				...
				\item Performance tuning \light{(frontend web)}
			\end{itemize}
		}
	\end{minipage}
...
\small
\light{%
Revision \repo{\COMMIT} (\today)\\
This document is written in {\lmr \LaTeX}, built in Docker, and continuously deployed with Azure Pipelines.
}
